...
~~- [--] eraMegaten_4935 (타카가키 카에데 GBF 사양) 도입~~

- [O] eraMegaten_5340 (타카가키 카에데 조정 by Neo) 도입

- [--] eraMegaten_6046 (238 로카파라 소수정) 포함

- [O] eraMegaten_6047 (사가판 패치 정리_Rev143용 불량 등 수정 패치) 도입
...
- [O] eraMegaten_6054 (eraMegaten_레뷰스터퍼라이트패치_전용스킬미세조정)포함

- [O] eraMegaten_6055 (흰 강철 X mod) 도입
...
- [O] eraMegaten_6071 (사가판 패치 정리_Rev143용 불량 등 수정 패치2+3+4) 도입
...
- [O] eraMegaten_6076 (사가판 패치 정리_Rev143용 불량 등 수정 패치5) 포함
...
- [O] eraMegaten_6091 ([구상 템플릿 VER3.3]미세 버그 수정) 도입
...
- [O] eraMegaten_6101 ([Aion식 소환술] 링고와 피그를 구현하는 패치) 도입
...
- [O] eraMegaten_6114 (아크나이츠_수르트 AN 전용기 수정 패치) 포함

- [O] eraMegaten_6119 (흰 강철 X mod) 도입
...
- [O] eraMegaten_6225 (아크나이츠_슬트가입이벤트수정패치)포함
...
- [O] eraMegaten_6265 (구상 VER3.4) 도입
...
- [--] eraMegaten_6277(사가판 패치 정리_Rev146용 불량품 등 수정 패치) 포함

- [--] eraMegaten_6278(로보가이베fix) 도입

- [--] eraMegaten_6279 (Rev146 버그 수정 각종) 도입

- [--] eraMegaten_6284 (위대한 쿠사나리를 위하여) 포섭

- [--] eraMegaten_6293(며느리장비추가패치)포함

- [--] eraMegaten_6294(사가판 패치 정리_Rev146용 불량품 등 수정 패치2+3+4) 포함

- [--] eraMegaten_6295 (롤 정비용 추가 수정 파일 5) 가져오기

- [--] eraMegaten_6297(카테드라 루푸츠오 강화판 추가 패치) 포함

- [O] eraMegaten_6298(사과, 피그이미지 추가) 포함

- [--] eraMegaten_6299(사가판 패치 정리_Rev146용 불량 등 수정 패치 2+3+4+5) 포함

- [--] eraMegaten_6300(침포 사이즈를 조교에 관련시키는 패치 1.01) 포함

- [--] eraMegaten_6301(위대한 쿠사나리를 위하여 (생명의 별자리) 포섭

- [--] eraMegaten_6303(오리지널 스킬의 내용물을 약간 정리) 포함

- [--] eraMegaten_6304(위대한 쿠사나리를 위하여 (생명의 별자리) 포섭

- [--] eraMegaten_6305(아라나기짱 이벤트 1.00) 도입

- [--] eraMegaten_6306(오리지널 스킬의 내용물을 약간 정리) 포함

- [--] eraMegaten_6307(아라나기짱 이벤트_1.01) 도입

- [--] eraMegaten_6308(아라나기짱 이벤트_1.02) 도입

- [--] eraMegaten_6309(개수)포함

- [--] eraMegaten_6310(2023-04-09 봄수정축제) 포섭

- [--] eraMegaten_6311(롤정비_정식판) 도입

- [--] eraMegaten_6312 (롤정비_정식판_버그수정추가) 도입

- [--] eraMegaten_6313(롤정비_정식판_버그수정추가2)포함

- [--] eraMegaten_6314(마가미군의 전용 스킬이 버그가 있는 것을 고치는 패치) 도입

- [--] eraMegaten_6315(롤정비_정식판_버그수정추가3)포함

- [--] eraMegaten_6317(마루로네 정비창) 도입

- [--] eraMegaten_6320(롤정비_정식판_버그수정추가5)포함